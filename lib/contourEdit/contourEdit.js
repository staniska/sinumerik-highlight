        ...
        eventData: {
            action: {
                ...
                reset: () => {
                    ...
                    view.contourEditData.doubleTraversalElementId = null
                }
            },
...
export const updateElementsOl = () => {
    ...
    View.sinumerikView.contourEditData.editContour.forEach((el, idx) => {
        ...
        const element_li_num = create_element(['editContourElement_num'], element_li, 'div', `${idx + 1}.`)
        const element_li_text = create_element(['editContourElement_text'], element_li, 'div', el.type)
        ...
        element_li.addEventListener('click', () => {
            ...
            element_li.scrollIntoView({block: 'nearest'})
