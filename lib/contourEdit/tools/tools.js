...
export const generateTools = () => {
    if (!View.sinumerikView.contourEditRightContainer.tools) {
        ...
        View.sinumerikView.contourEditRightContainer.processing.ol.fileFromArea.btn = create_element(['contourEditButton'], View.sinumerikView.contourEditRightContainer.processing.ol.fileFromArea, 'Area => file', 'button')
