...
export const updateContourEditData = async () => {
    const fileName = normalizeFileName(atom.workspace.getActiveTextEditor().getTitle())
...
export const save_contours = () => {
    let fileName = normalizeFileName(atom.workspace.getActiveTextEditor().getTitle())
