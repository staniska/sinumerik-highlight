...
function machineOptions(machineName) {
    ...
    if (!View.sinumerikView.machineManagerMainWindow.machineOptions) {
        ...
        View.sinumerikView.machineManagerMainWindow.machineOptions.subroutinesDiv.head.innerText = 'Subroutines';
        ...
        View.sinumerikView.machineManagerMainWindow.machineOptions.subroutinesDiv.addButton.addEventListener('click', function() {
            ...
            if (path) {
                ...
                View.sinumerikView.machineData.subroutines[View.sinumerikView.machineManagerData.selectedMachine].push(path);
                saveMachineData();
