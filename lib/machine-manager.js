    ...
    if (Editor.getTitle().split('.')[1].toUpperCase().match("MPF|SPF")) {
        if (View.sinumerikView.programmData[filename].machine) {
            if (searchMachine(View.sinumerikView.programmData[filename].machine.machineName, true).length == 0) {
                console.log('Не найдено машины с соответствующим именем.')
...
function machineManagerCreateMachineMainDiv(event) {
    ...
    if (event == 'createNewMachineSubmitClick') {
        ...
        if (newMachine.machineType == 'Lathe') {
            ...
            newMachine.subType == View.sinumerikView.machineManagerCreateMachineMainDiv.subTypeSelect.value;
            newMachine.incrementMove = View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.value;
            // console.log(newMachine.incrementMove);
    ...
    if (event == 'createNewMachineLatheSelect') {
        if (!View.sinumerikView.machineManagerCreateMachineMainDiv.subTypeSelectDiv) {
            ...
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelectDiv = document.createElement('div');
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelectDiv.className = 'sinumerikDiv';
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelectDiv.innerText = 'Please select X axis IC(increment) move type  ';

            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect = document.createElement('select');
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.className = 'sinumerikSelect';
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.radius = document.createElement('option');
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.radius.innerText = 'Radius';
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.appendChild(View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.radius);
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.diametr = document.createElement('option');
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.diametr.innerText = 'Diameter';
            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.appendChild(View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect.diametr);

            View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelectDiv.appendChild(View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelect);
        ...
        View.sinumerikView.machineManagerCreateMachineMainDiv.insertBefore(View.sinumerikView.machineManagerCreateMachineMainDiv.incrementSelectDiv, View.sinumerikView.machineManagerCreateMachineMainDiv.submitButtonDiv);
