...
function _buildScene3D(scene, elementLimit, sourceElements) {
    ...
    if (View.sinumerikView.parseData.blank)   scene.add(createMesh(View.sinumerikView.parseData.blank,   blankColor))
    if (View.sinumerikView.parseData.contour) scene.add(createMesh(View.sinumerikView.parseData.contour, contourColor, 0.1))
