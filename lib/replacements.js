...
export let replacements = {};
    ...
    //SIN
    replacements.Math.desired[1] = 'ASIN';
    replacements.Math.substitution[1] = 'myMath.asin';
    //COS
    replacements.Math.desired[2] = 'ACOS';
    replacements.Math.substitution[2] = 'myMath.acos';
    //ASIN
    replacements.Math.desired[3] = 'SIN';
    replacements.Math.substitution[3] = 'myMath.sin';
    //ACOS
    replacements.Math.desired[4] = 'COS';
    replacements.Math.substitution[4] = 'myMath.cos';
    //ATAN2
