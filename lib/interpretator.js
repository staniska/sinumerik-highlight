    ...
    if (Object.keys(move).length) {
        ...
        if (View.sinumerikView.parseData.moveGroup.match(/G2|G3/)) {
            ...
            if (!circleError) {
                ...
                //     var endPointCoords = {};
                //
                //     endPointCoords[circleAxes[0]] = parseFloat(myMath.cos(vectorEndAng) * circleRarius + move[circleCenterAxes[0]]);
                //     endPointCoords[circleAxes[1]] = parseFloat(myMath.sin(vectorEndAng) * circleRarius + move[circleCenterAxes[1]]);
                //     endPointCoords[circleAxes[2]] = canvasElement[`${circleAxes[2]}_start`] + (canvasElement[circleAxes[2]] - canvasElement[`${circleAxes[2]}_start`]);
                //
                //     var endPoint = getCoordinatesInBase(endPointCoords);
                //     canvasCircleElement = {
                //         X_start: View.sinumerikView.parseData.axesPos.X,
                //         Y_start: View.sinumerikView.parseData.axesPos.Y,
                //         Z_start: View.sinumerikView.parseData.axesPos.Z,
                ...
                //         type: 'G2'
                //     }
                //     canvasCircleElement[circleCenterAxes[0]] = move[circleCenterAxes[0]];
                //     canvasCircleElement[circleCenterAxes[1]] = move[circleCenterAxes[1]];
                //     canvasCircleElement.plane = View.sinumerikView.parseData.plane;
                //
                //     console.log(canvasCircleElement);
                // }
