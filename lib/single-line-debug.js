...
function generateSLDComponents() {
    ...
    View.sinumerikView.rendererToggleButton = document.createElement('button');
    View.sinumerikView.rendererToggleButton.className = 'sinumerikButton sinumerikSLDRendererToggle';
    View.sinumerikView.rendererToggleButton.innerText =
        View.sinumerikView.singleLineDebugData.useWebGL ? 'Canvas' : 'WebGL';
    View.sinumerikView.rendererToggleButton.title =
        'Switch between Canvas 2D and WebGL renderer';
    View.sinumerikView.rendererToggleButton.addEventListener('click', () => switchRenderer());
    View.sinumerikView.singleLineDebugParseStringDiv.prepend(View.sinumerikView.rendererToggleButton);
...
function switchRenderer() {
    ...
    const btn = View.sinumerikView.rendererToggleButton;
    btn.innerText = data.useWebGL ? 'Canvas' : 'WebGL';
