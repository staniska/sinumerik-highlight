...
function generateSLDComponents() {
    ...
    View.sinumerikView.singleLineDebugCanvas.addEventListener('keyup', (e) => {
        if (e.key = 'Control') {
            console.log('keyUp')
            View.sinumerikView.singleLineDebugCanvas.action = null
        }
    ...
    //TODO сделать возможность вертеть вид
    View.sinumerikView.singleLineDebugCanvas.addEventListener('keydown', (event) => {
        if (event.key === 'Control') {
            console.log('keyDown')
            View.sinumerikView.singleLineDebugCanvas.style.cursor = 'crosshair'
            View.sinumerikView.singleLineDebugCanvas.action = 'rotation'
        }
    })
