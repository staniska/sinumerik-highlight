...
import {scrollCanvas} from "./contourEdit/canvas";
...
function generateSLDComponents() {
    ...
    //TODO надо чтото сделать для обработки скролла :-)
    View.sinumerikView.singleLineDebugCanvas.addEventListener('wheel', event => {
        ...
        View.sinumerikView.singleLineDebugData.canvasRange += Math.abs(delta)/delta * Number((View.sinumerikView.singleLineDebugData.canvasRange / 50).toPrecision(1))
