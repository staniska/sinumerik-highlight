...
//region contour
    ...
    View.sinumerikView.singleLineDebugContourDiv.style.display = 'flex'
    ...
    contourDuplicate.style.height = '20px'
    contourDuplicate.style.width = '20px'
    contourDuplicate.style.margin = 0
    contourDuplicate.style.alignSelf = 'center'
