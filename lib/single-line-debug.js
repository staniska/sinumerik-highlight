...
function _sldScrollToElement(el) {
    ...
    if (mainEditor) {
        ...
        _sldMainDecoration = {marker}
        mainEditor.scrollToBufferPosition([mainRow, 0], {center: true})
    }
    ...
    if (el.mainRow !== undefined && el.sourceFile) {
        ...
        if (subEditor) {
            ...
            _sldSubDecoration = {marker}
            subEditor.scrollToBufferPosition([el.row, 0], {center: true})
        }
    }
}
