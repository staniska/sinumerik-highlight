...
function checkChanges() {
    ...
    if (filename.split('_')[1].match(/MPF|MPS/)) {
...
function generateSLDData() {
    ...
    if (!filename.match(/MPF|MPS/)) {
        errorDiv('File extension must be MPF or MPS');
        return;
    }
...
//        console.log(View.sinumerikView.singleLineDebugData.machine);
...
function generateSLDComponents() {
    ...
    View.sinumerikView.singleLineDebugParseStringDiv.stringDiv.innerText = 'hello!';
    ...
    View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton = document.createElement('button');
    View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton.className = 'sinumerikButton icon-x';
    View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton.innerText = 'close Details';
    View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton.style.float = 'right';
    View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton.addEventListener('click', function () {
        sinumerikEventHandler('{"emitter": "singleLine", "event": "stringParseDetailsCloseButtonClick"}');
    });

    View.sinumerikView.singleLineDebugStringParseDetailsDiv.appendChild(View.sinumerikView.singleLineDebugStringParseDetailsDiv.closeDetailsButton);
    ...
    View.sinumerikView.singleLineDebugViewDiv.XYPlaneButton.disabled = true;
    ...
    View.sinumerikView.singleLineDebugViewDiv.YZPlaneButton.disabled = true;
...
function canvasRange (event) {
    ...
    if (event == '' || event == undefined) {
        console.log('Reset canvas range');
...
function drawAxes(ctx) {
    ...
    var centerText = View.sinumerikView.singleLineDebugData.CanvasAxes.axes[0] + ':' +  View.sinumerikView.singleLineDebugData.canvasCentrPoint[0].toFixed(3) +
                    ' ' + View.sinumerikView.singleLineDebugData.CanvasAxes.axes[1] + ':' +  View.sinumerikView.singleLineDebugData.canvasCentrPoint[1].toFixed(3);
