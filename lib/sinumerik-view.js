...
export default class SinumerikView {
  ...
  constructor(serializedState) {
    console.log(atom);
    this.activeTab = "jopa";
    this.singleLineDebugVisiblity = 'visible';
    this.counturEditVisiblity = 'hidden';
  ...
  singleLineDebug() {
    ...
    this.singleLineDebugFootContainer.style.visibility = this.singleLineDebugVisiblity;
 ...
 //Foot controls
    ...
    this.singleLineDebugMainWindow.style.visibility = this.singleLineDebugVisiblity;
  ...
  counturEdit() {
    ...
    this.counturEditFootContainer.style.visibility = this.counturEditVisiblity;
    ...
    this.counturEditMainWindow.style.visibility = this.counturEditVisiblity;
