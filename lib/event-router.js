...
function changeActiveTab(newTab) {
    if (View.sinumerikView.activeTab != newTab) {
        ...
        if (newTab == 'singleLine') {
            ...
            View.sinumerikView.singleLineDebugVisiblity = 'visible';
            View.sinumerikView.counturEditVisiblity = 'hidden';
        } else if (newTab == 'counturEdit') {
            counturEditDelay = visibilityDelay;
            View.sinumerikView.singleLineDebugVisiblity = 'hidden';
            View.sinumerikView.counturEditVisiblity = 'visible';
        } else {
...
function setCounturEditVisibility() {
    View.sinumerikView.counturEditFootContainer.style.visibility = View.sinumerikView.counturEditVisiblity;
    View.sinumerikView.counturEditMainWindow.style.visibility = View.sinumerikView.counturEditVisiblity;
}

function setSingleLineDebugVisibility() {
    View.sinumerikView.singleLineDebugFootContainer.style.visibility = View.sinumerikView.singleLineDebugVisiblity;
    View.sinumerikView.singleLineDebugMainWindow.style.visibility = View.sinumerikView.singleLineDebugVisiblity;
}